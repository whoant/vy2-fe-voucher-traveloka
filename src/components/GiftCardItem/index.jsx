...
function VoucherItem(props) {
    const { type } = props;
    const { imageUrl, title, giftCardCode, pointExchange, effectiveAt, expirationAt, description } = props.giftCard;
    const navigate = useNavigate();

    const handleClickDetail = () => {
        navigate(`/partner/gift-card/${type}/${giftCardCode}`, { replace: true });
    }
                ...
                <div className="card-body pt-4">
                    <div className="d-flex align-items-center mb-7">
                        ...
                        <div className="d-flex flex-column">
                            ...
                            <span className="text-muted font-weight-bold">{giftCardCode}</span>
                        </div>
                    </div>
                    ...
                    <div className="mb-7">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                            <span className="text-dark-75 font-weight-bolder mr-2">Số điểm để đổi :</span>
                            <span className="text-muted text-hover-primary">{pointExchange}</span>
                        </div>
                    </div>
                    <a href="#"
