...
const Layout = props => {
    ...
    useEffect(() => {
        const storageUser = localStorage.getItem('partner');
        if (!storageUser) {
                            ...
                            <div id="kt_aside_menu" className="aside-menu my-4" data-menu-vertical={1}
                                ...
                                <ul className="menu-nav">
                                    <li className="menu-item" aria-haspopup="true">
                                        <Link to="/partner/dashboard" className="menu-link"><span
                                            className="menu-text">Dashboard</span></Link>
                                    </li>

                                    <li className="menu-item" aria-haspopup="true">
                                        <Link to="/partner/voucher" className="menu-link"><span
                                            className="menu-text">Danh sách voucher</span></Link>
                                    </li>
                                    <li className="menu-item" aria-haspopup="true">
                                    ...
                                    <li className="menu-item" aria-haspopup="true">
                                        <Link to="/partner/create-gift-partner" className="menu-link"><span
                                            className="menu-text">Tạo thẻ quà tặng</span></Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
