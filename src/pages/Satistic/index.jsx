            ...
            <div className="card card-custom col-md-8">
                <div className="card-header border-0 py-5">
                    ...
                    <div className="card-toolbar">
                        <a href="/createVoucher" className="btn btn-danger font-weight-bolder font-size-sm">Tạo mới voucher</a>
                    </div>
                </div>
                            ...
                            <table className="table table-head-custom table-head-bg ">
                                ...
                                <tbody >
                                    <tr className=''>
                                        <td>
                                            <div>
                                                <a href="#" className="text-dark-75 font-weight-bolder text-decoration-none text-hover-primary mb-1 font-size-lg">Voucher_1</a>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr className=''>
                                        ...
                                        <td className='pr-0'>
                                            <button href="#" className="btn btn-light font-weight-bolder font-size-sm">Chi tiết</button>
                                        </td>
                                    </tr>    
                            </tbody>
                            </table>
...
SatisticPage.propTypes = {
    
};

export default SatisticPage;